...
var RealRemovals = GenerateReals()

func GenerateReals() map[string]bool { // TODO: remove this debugging code
	ret := map[string]bool{}
	file, err := os.OpenFile("/home/brannon/Workspace/c/lbrycrd/removals.txt", os.O_RDONLY, 0644)
	if err != nil {
		return ret
	}
	defer file.Close()
